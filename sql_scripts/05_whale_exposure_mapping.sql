WITH top_debtors AS (
    -- Step 1: Identify the Top 10 USDT borrowers during the specific crash window
    SELECT 
...
-- Step 2: Calculate human-readable amounts and convert them to USD values
SELECT 
    CASE 
    ...
    -- Column A: Adjusted Token Quantity (Handling Decimals)
    ROUND(SUM(s.amount) / POWER(10, 
        CASE 
            ...
            ELSE 18 
        END), 2) AS token_amount,

-- Column B: Estimated USD Value of Collateral
    ROUND(SUM(s.amount) / POWER(10, 
        CASE 
            WHEN s."reserve" = 0x2260fac5e5542a773aa44fbcfedf7c193bc2c599 THEN 8 
            WHEN s."reserve" IN (0xdac17f958d2ee523a2206206994597c13d831ec7, 0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48) THEN 6 
